...
CREATE SCHEMA IF NOT EXISTS `test-secyield` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `test-secyield` ;

-- -----------------------------------------------------
-- Table `test-secyield`.`customer_security_sec_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-secyield`.`customer_security_sec_data` (
...
-- -----------------------------------------------------
-- Table `test-secyield`.`customer_fund_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-secyield`.`customer_fund_data` (
  `security_identifier` VARCHAR(128) NOT NULL,
  ...
  CONSTRAINT `customer_fd_s_fk`
    ...
    REFERENCES `test-secyield`.`customer_security_sec_data` (`security_identifier` , `report_date`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `test-secyield`.`customer_position_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-secyield`.`customer_position_data` (
  `security_identifier` VARCHAR(128) NOT NULL,
  `portfolio_number` DECIMAL(20,7) NOT NULL,
  `report_date` DATETIME NOT NULL,
...
-- -----------------------------------------------------
-- Table `test-secyield`.`calculated_security_sec_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-secyield`.`calculated_security_sec_data` (
  `security_identifier` VARCHAR(128) NOT NULL,
  `report_date` DATETIME NOT NULL,
  `iv_type` VARCHAR(24) NOT NULL,
  `security_name` VARCHAR(512) NOT NULL,
...
-- -----------------------------------------------------
-- Table `test-secyield`.`calculated_fund_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-secyield`.`calculated_fund_data` (
  `security_identifier` VARCHAR(128) NOT NULL,
  `portfolio_number` DECIMAL(20,7) NOT NULL,
  `portfolio_name` VARCHAR(256) NOT NULL,
  `report_date` DATETIME NOT NULL,
  ...
  CONSTRAINT `customer_fd_s_fk0`
    FOREIGN KEY (`security_identifier` , `report_date`)
    REFERENCES `test-secyield`.`calculated_security_sec_data` (`security_identifier` , `report_date`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `test-secyield`.`calculated_position_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-secyield`.`calculated_position_data` (
  `security_identifier` VARCHAR(128) NOT NULL,
  `portfolio_number` DECIMAL(20,7) NOT NULL,
  `report_date` DATETIME NOT NULL,
  `earned_inflationary_compensation_base` DECIMAL(20,7) NULL,
