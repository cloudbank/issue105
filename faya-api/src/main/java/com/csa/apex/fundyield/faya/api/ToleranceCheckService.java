...
public interface ToleranceCheckService {
    ...
    @ResponseBody
    public void initiateSECFundLevelBatchToleranceCheck(Date reportDate);
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public void initiateMoneyMarketFundLevelBatchToleranceCheck(Date reportDate);
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public void initiateSecurityLevelBatchToleranceCheck(Date reportDate);
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ToleranceCheckResult getSecurityLevelWhatIfToleranceCheckResult( Date reportDate, String cusip);
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public void initiatePositionLevelWhatIfToleranceCheck( Date reportDate, String cusip, int portfolioHoldingSnapshotSid);
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ToleranceCheckResult getPositionLevelWhatIfToleranceCheckResult( Date reportDate, String cusip, int portfolioHoldingSnapshotSid);
}
