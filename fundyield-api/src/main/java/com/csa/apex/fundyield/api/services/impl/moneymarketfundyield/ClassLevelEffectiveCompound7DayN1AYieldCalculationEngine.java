...
/**
 * Class Level Effective Compound 7 Day N1A Yield calculation engine. Effectively thread safe after configuration.
 */
@Component
        ...
        try {
            for (Portfolio portfolio : fundAccountingYieldData.getPortfolios()) {
                ...
                for (ShareClass shareClass : portfolio.getShareClasses()) {
                    ...
                    BigDecimal d = snapshot.getDerMnyMkt7DayN1AYieldPct();
                    BigDecimal y = d.add(utilityCustomerAPIClient
                    ...
                    snapshot.setDerMnyMktN1ACompound7dayYield(
