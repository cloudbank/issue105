...
public class ClassLevelRestated30DayYieldCalculator {
	...
	public ClassLevelRestated30DayYieldCalculationOutput calculate(ClassLevelRestated30DayYieldCalculationInput input) {
		...
		BigDecimal derMmRst30DayYieldPct = derMmRestate1DayYieldPct.add(dPrevious29Days);
		derMmRst30DayYieldPct = derMmRst30DayYieldPct.divide(BigDecimal.valueOf(30), input.getOperationScale(),
