...
/**
* Test class for the ClassLevelEffectiveCompound7DayN1AYieldCalculationEngine.
*
* @author TCSDEVELOPER
* @version 1.0
*/
...
@IntegrationTest
public class ClassLevelEffectiveCompound7DayN1AYieldCalculationEngineTest {
    /**
    ...
    public void calculate() throws Exception {
        ClassLevelEffectiveCompound7DayN1AYieldCalculationEngine instance = new ClassLevelEffectiveCompound7DayN1AYieldCalculationEngine();
