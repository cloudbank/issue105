...
public class PortfolioHoldingSnapshot extends Adjustable {
    ...
    /**
     * A Code indicating different (BusinessGroup/System) views of the data. Initial phase of the project will focus on
     * FA (Fund Accounting View) The diff views could be based on (BusinessGroup, or usually Accounting groups/systems)
     * : Ex: FA Fund Accounting view A1 Tax view - for e-Tax application looks at it from tax focused way IA InvestOne
     * only view, Adjusted mo-end view (1st 3 business days of a moth, prev month numbers are adjusted and reported)
     * etc.
     */
    ...
    /**
     * A code indicating different (TimePeriod) views of the data. Initial phase of the project will focus on EOD (End
     * of Day View) Ex: SOD - Start of Day view of the data EOD - End of Day view of the data T1M data as of 1st
     * business day of the month T2M data as of 2nd business day of the month T3M data as of 3rd business day of the
     * month ME month end.
     */
    ...
    /**
     * Indicates whether the position is held long or short. "LONG" or "SHORT". In this application, business, is only
     * interested in tracking securities held in long position. Hence all rows might end up having the same value i.e.
     * "LONG". Keeping this column on the holdings table as across different applications, position code is part of
     * alternate key on the holdings table.
     */
    ...
    /**
     * Market value in Base currency. MktVal is a position level, and is at shares*price. point-in-time, Daily snapshot
     * and not a cumulative amount.
     */
    ...
    /**
     * Number of Shares of a security held by a given fund. Also referred to as Share Par.
     */
    @ColumnName("SETTLE_SHARE_CNT")
    private BigDecimal settleShareCnt;

    /**
     * This is a value specific to Mortgage backed securities, which shows the number of shares that was used to
     * calculate the original Face Amount. Used in deriving the true current factor (esp.when currentFactor=0).
     */
    @ColumnName("ORIGINAL_FACE_SHARE_QTY")
    private BigDecimal originalFaceShareQty;

    /**
     * one fx rate per security, and always against used. Valid Values: 1.5 (implies For local JPY-USD exchange rate,
     * 1.5 JPY is equal to One USD. fx-rate - pulled at position level from Accounting system, hence recording at
     * position level in this model.
     */
    @ColumnName("FX_RT")
    private BigDecimal fxRt;

    /**
     * One day income amount as calculated in SEC yield application. Income is calculated at position level (i.e.
     * Fund/Portfolio and Security level).
     */
    ...
    /**
     * Number of Shares of a security held by a given fund. Also referred to as Share Par, as adjusted by business user
     * usually via UI.
     */
    ...
    /**
     * Accrued income for a given reporting date as adjusted by business user usually via UI.
     */
    @ColumnName("ADJ_ACCRUED_INCOME_AMT")
    private BigDecimal adjAccruedIncomeAmt;

    /**
     * earned amortization amount in base currency as adjusted by business user usually via UI.
     */
    @ColumnName("ADJ_EARNED_AMORT_BASE_AMT")
    private BigDecimal adjEarnedAmortBaseAmt;

    /**
     * earned Inflationary Compensation amount in Base currency as adjusted by business user usually via UI.
     */
    @ColumnName("ADJ_EARNED_INFL_CMPS_BASE_AMT")
    private BigDecimal adjEarnedInflCmpsBaseAmt;

    /**
     * comments associated with the adjustments. Comments from the previous adjustment will be either overwritten or new
     * comments can be appended for the same reporting period if needed..
     */
     ...
     * @param tradableEntity value to be assigned to property tradableEntity
     */
     ...
     * @param holdingBusinessGroupViewCd value to be assigned to property holdingBusinessGroupViewCd
     */
     ...
     * @param holdingViewCd value to be assigned to property holdingViewCd
     */
     ...
     * @param positionCd value to be assigned to property positionCd
     */
     ...
     * @param accruedIncomeAmt value to be assigned to property accruedIncomeAmt
     */
     ...
     * @param earnedAmortBaseAmt value to be assigned to property earnedAmortBaseAmt
     */
     ...
     * @param earnedInflCmpsBaseAmt value to be assigned to property earnedInflCmpsBaseAmt
     */
     ...
     * @param marketValueBaseAmt value to be assigned to property marketValueBaseAmt
     */
     ...
     * @param inflationAdjShareCnt value to be assigned to property inflationAdjShareCnt
     */
     ...
     * @param settleShareCnt value to be assigned to property settleShareCnt
     */
     ...
     * @param originalFaceShareQty value to be assigned to property originalFaceShareQty
     */
     ...
     * @param fxRt value to be assigned to property fxRt
     */
     ...
     * @param derSecYield1DayIncomeAmt value to be assigned to property derSecYield1DayIncomeAmt
     */
     ...
     * @param adjDerSecYield1ayIncAmt value to be assigned to property adjDerSecYield1ayIncAmt
     */
     ...
     * @param adjDerMarketValueBaseAmt value to be assigned to property adjDerMarketValueBaseAmt
     */
     ...
     * @param adjSettleShareCnt value to be assigned to property adjSettleShareCnt
     */
     ...
     * @param adjAccruedIncomeAmt value to be assigned to property adjAccruedIncomeAmt
     */
     ...
     * @param adjEarnedAmortBaseAmt value to be assigned to property adjEarnedAmortBaseAmt
     */
     ...
     * @param adjEarnedInflCmpsBaseAmt value to be assigned to property adjEarnedInflCmpsBaseAmt
     */
     ...
     * @param adjCommentsTxt value to be assigned to property adjCommentsTxt
     */
