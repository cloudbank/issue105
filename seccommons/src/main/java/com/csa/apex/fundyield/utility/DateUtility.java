...
public class DateUtility {
    ...
    /**
     * Compares date for month and year. So 12 July 2016 and 18 July 2016 will return true as both month and year
     * matches.
    ...
    /**
     * Implementation of the day360 method. This computes the difference in days between the startDate and the endDate,
     * based on a 360-day year, divided into twelve 30-day months. This implementation uses the US(NASD) method (quoted
     * from https://support.microsoft.com/en-us/kb/235575): - If the starting date is the 31st of a month, it becomes
     * equal to the 30th of the same month. - If the ending date is the 31st of a month and the starting date is NOT the
     * last day of a month, the ending date becomes equal to the 1st of the next month, otherwise the ending date
     * becomes equal to the 30th of the same month. - If the start date is the last day of February, then extra days
     * added to February are ignored.
