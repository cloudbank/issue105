...
public class SecuritySECDataTest {
    ...
    public void toStringTest() throws ParseException {
        ...
        String expected = "SecuritySECData{securityIdentifier='1111', reportDate=01/15/2016, securityReferenceData=null, derCleanPrice=1111, positionData=[PositionData{securityIdentifier='SecId', portfolioNumber=1111, portfolioName='PORT1', reportDate=01/15/2016, earnedInflationaryCompensationBase=1111, accruedIncome=1111, marketValue=1111, sharePerAmount=1111, earnedAmortizationBase=1111, positionValInflationAdjShares=1111, derOneDaySecurityIncome=1111}], derYieldCalcEngine='1111', derIncomeCalcEngine='1111', derOneDaySecurityYield=1111, derRedemptionDate=01/15/2016, derRedemptionPrice=1111, derSecurityType='SEC1111', derTIPSInflationaryRatio=1111, securityPrice=1111.109999999999899955582804977893829345703125, fxRate=2222.5}";
