...
public class YtmYieldCalculationEngine implements CalculationEngine {
	...
	/**
	 * The YTM (TIPS) Yield calculation engine. Uses symja to evaluate equation
	 * and find the unknown value of Y (Yield)
	 */
	...
	/**
	 * It defines the least error in the calculation There can be max error =
	 * ephsilon More the value accurate is result
	 */
	...
	/**
	 * Read from configuraion object and override the operationScale default
	 * value
	 * 
	 * @param configuration
	 ...
	 * 
	 * @param ytmYieldCalculationVariablesDTO
	 *            YtmYieldCalculationVariablesDTO object contains value for
	 *            calculation
	 * @param yield
	 *            End yield value for binary search, start yield value is
	 *            calculated in method using calculationStep
	 * @return yield value
	 */
	 ...
	 * increases yield value from ephsilon and checks whether yield function
	 * gives zero value. Then it uses binary search to imprive accuracy of
