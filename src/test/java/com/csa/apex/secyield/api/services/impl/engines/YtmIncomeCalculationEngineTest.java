...
public class YtmIncomeCalculationEngineTest {
	...
	/**
	 * Ytm income calculation
	 * mv = 70135342.4
	 * ai = 257693.72
	 * y = 0.00948961511103637
	 * infllnc = -4956.56
	 * 
	 * @throws Exception
	 */
	...
	public void checkIncomeCalculationTest1() throws Exception {
		...
		assertEquals(securitySECData.getPositionData()[0].getDerOneDaySecurityIncome().setScale(0, BigDecimal.ROUND_HALF_DOWN), new BigDecimal(-3101).setScale(0, BigDecimal.ROUND_HALF_DOWN));
	}
	...
	public void checkIncomeCalculationTest2() throws Exception {
		...
		configuration.setOperationScale(7);
		ytmIncomeCalculationEngine.calculate(securitySECData, configuration);
		assertEquals(securitySECData.getPositionData()[0].getDerOneDaySecurityIncome().setScale(2, BigDecimal.ROUND_HALF_DOWN), new BigDecimal(34150.68).setScale(2, BigDecimal.ROUND_HALF_DOWN));
	}
