...
public class CountryResourceIntTest {
    ...
    public void createCountry() throws Exception {
        ...
        restCountryMockMvc.perform(post("/countries")
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/countries?sort=id,desc"))
    ...
    public void getCountry() throws Exception {
        ...
        // Get the country
        restCountryMockMvc.perform(get("/countries/{id}", country.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    public void getNonExistingCountry() throws Exception {
        // Get the country
        restCountryMockMvc.perform(get("/countries/{id}", Long.MAX_VALUE))
    ...
    public void updateCountry() throws Exception {
        ...
        restCountryMockMvc.perform(put("/countries")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
    ...
    public void deleteCountry() throws Exception {
        ...
        // Get the country
        restCountryMockMvc.perform(delete("/countries/{id}", country.getId())
